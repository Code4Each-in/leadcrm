    ...
    <div class="col-12 grid-margin stretch-card">
        ...
        <div class="card" id="leadImportCard">
            <div class="card-body">
                ...
                @if (session('importErrors'))
                    ...
                    <div class="import-summary">
                        ...
                        <div class="import-summary-item">
                            ...
                            <div class="import-summary-label">Leads created</div>
                        </div>
                    </div>
                    ...
                    <div class="section-heading mb-3">
                        ...
                        <div>
                            ...
                            <p class="card-description mb-0">
                                ...
                                <a href="{{ route('leads.csv.template', $product) }}">Download the template</a>
                                for {{ $product->name }} to get started.
                            </p>
                        </div>
                    </div>
                ...
                <form
                    method="POST"
                    action="{{ route('leads.import.store', $product) }}"
                ...
                >
                    ...
                    <div class="form-group">
                        ...
                        {{--
                            Same file-choose control used elsewhere in the
                            app (Lead Notes & Documents, Profile Photo,
                            Users) - readonly filename + Browse button,
                            one joined control, click-anywhere opens the
...
<style>
    ...
    /* Choose-file control - same pattern as leads/show.blade.php's
       document upload, profile/index.blade.php's photo upload, and
       users/index.blade.php - one joined control (readonly filename +
    ...
    /* .action-buttons previously relied on the "me-2" utility class
       for the gap between buttons - this theme only ships Bootstrap
       4-style "mr-*" classes, not Bootstrap 5's "me-*", so that class
       was a silent no-op and the buttons rendered touching each
       other. An explicit gap here (same value used for
       .leads-header-actions / .csv-modal-actions elsewhere in this
       module) replaces it. */
    #leadImportCard .action-buttons {
        gap: 10px;
    }

    /* Compact padding matching the other standalone action buttons in
       this module (e.g. .btn-csv-action on leads/index.blade.php) -
       the bulkier .px-4 utility read as oversized next to the more
       compact .file-upload-field above it. */
...
<script>
    /*
     * Same delegated click-anywhere-opens-the-hidden-input behavior
     * used on the Lead Notes & Documents upload, Profile Photo
     * upload, and Users page.
     */
